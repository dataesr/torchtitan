...
def qwen3_balanced_600m_ack_reasoning() -> Trainer.Config:
    ...
    return Trainer.Config(
        dump_folder="?",
        hf_assets_path="/gpfs/home/plei/plei749549/pleias_65k_tokenizer",
            ...
            dataset=ConcatThenSplitPackingConfig(
                dataset=SingleDatasetConfig(
                    source=HuggingFaceStreamingSource.Config(
                        ...
                        load_dataset_kwargs={
                            "data_files": (
                                "/gpfs/scratch/ehpc384/SYNTH_COMMON_CORPUS/"
                                "ack_reasoning_full_v2schema/*.jsonl"
                            ),
                        },
                    ),
        ...
        checkpointer=CheckpointManager.Config(
            ...
            initial_load_path="/gpfs/scratch/ehpc384/annotation/balanced_600m/run_20260314/checkpoint/step-151000",
